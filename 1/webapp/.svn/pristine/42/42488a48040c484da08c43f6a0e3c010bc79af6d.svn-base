...
$extend(Array.prototype, {
    each: function(a) {
        for (var b = 0, c = this.length; b < c; b++)
            if ((a ? a(this[b], b) : this[b]()) === !1) return !1;
        return !0
    }
});
...
function $fixElement(a) {
    ...
    function c(a) {
        for (var a = a.getElementsByTagName("input"), b = 0; b < a.length; b++)
            if (/checkbox|radio/.test(a[b].type)) return a[b];
        return null
    }
...
var DOM = function() {
    function a(a) {
        return function(b) {
            for (var b = $fixE(b), c = a.module.event[b.type], d, f = 0; f < c.length; f++)
                if (c[f].enabled) try {
        ...
        function(a, b) {
            ...
            b.$each = function(a) {
                ...
                if ($isUndefined(b.length)) a.call(this, b, 0);
                    ...
                    for (var g = 0; g < b.length && (c = a.call(this, b[g], g)) !== !1; g++);
                return c === !1 ? 0 : 1
            };
    ...
    if (this.nodeType == 1) {
        ...
        if (/^SELECT$/.test(this.tagName)) this.$setValue = function(a) {
            for (var b = 0; b < this.options.length; b++)
                if (this.options[b].value == a) return this.selectedIndex = b, !0;
            return !1
        }
    }
        ...
        function b(a, c) {
            ...
            if (g[1] == "#")(f = A$(g[2])) && d.push(f);
                ...
                for (var v = 0; v < c.length; v++)
                    if (f = c[v].A$(g[2]))
                        for (var w = 0; w < f.length; w++) d.push(f[w]);
            g[3].replace(/\[([^!=]+)(=|!=)([^\]]*)\]/gi,
                function(a, b, c, g) {
                    a = d.slice(0);
                    d = [];
...
(function() {
    ...
    anjiehotel.module.address = function(k) {
        ...
        function N() {
            for (var a = u.getElementsByTagName(f.cityListTagName), b = 0; b < a.length; b++)
                if (a[b].style.display == "") return a[b];
            return null
        }
            ...
            u.onmousedown = function(b) {
                ...
                if (f.olObj) {
                    ...
                    if (b && d) {
                        ...
                        a: {
                            for (var d = _.$s2t(k.hotSelected), g = u.getElementsByTagName(f.cityListTagName), w = 0; w < g.length; w++)
                                if (g[w].getAttribute("type") == d) {
                                    d = g[w];
                                    break a
                                }
                            d = null
                        ...
                        a: {
                            ...
                            for (d = 0; d < b.length; d++)
                                if (a(b[d], f.hotClassNames.tagSelected)) {
                                    b = b[d];
                                    break a
                                }
                            b = null
        ...
        function L() {
            ...
            var a = k.value.trim();
            if (a !== I)
                if (I = a, a = a.replace(/([\(\)\\\[\]\.\+\?\*\|\^\$])/gi, "\\$1").replace(/@|\|/gi, ""), C && $$.module.address.source[o.source + d]) V(),
                    C = !1,
                    f.hotTarget = u;
                else {
